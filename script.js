...
// // Function to start a new game (resets game state after a loss)
...
//         gameInProgress = true; // Allow a new game to begin
//     }
...
//     // Hide the New Game button until the game is lost
...
//         // Make sure the animation repeats for each correct guess
//         setTimeout(() => {
//             gameStatus.classList.remove('celebration'); // Remove celebration class to reset it
//             gameStatus.classList.add('celebration'); // Reapply celebration animation
//         }, 1000);  // Adjust this delay to match your animation duration

//         // After a short delay, continue with a new game (with the same score)
...
//         // Show the New Game button after Game Over
...
// // Set up new game button to manually reset the game (reset score)
// newGameButton.onclick = () => {
//     score = 0; // Reset score
//     scoreElement.textContent = `Score: ${score}`; // Update score display
//     newGameButton.style.display = 'none';  // Hide the New Game button
//     gameInProgress = true; // Ensure the game is allowed to progress again
//     startNewGame(); // Start a new game with reset score
// };
